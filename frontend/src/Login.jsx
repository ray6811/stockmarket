...
export default function Login({onLogin}){
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-indigo-900 text-white">
      <form onSubmit={submit} className="bg-gradient-to-b from-slate-800 to-slate-900 p-8 rounded-xl w-full max-w-md shadow-xl border border-slate-700">
        ...
        <button className="w-full bg-emerald-400 text-black font-semibold p-3 rounded">Sign in</button>
